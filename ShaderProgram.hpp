...
public:
	...
	GLuint id(void) { return ID; }
	GLint attrib_pos (void) { return glGetAttribLocation(ID, "attribute_Position"); }
	GLint attrib_norm(void) { return glGetAttribLocation(ID, "attribute_Normal"); }
	GLint attrib_tex (void) { return glGetAttribLocation(ID, "attribute_TexCoord"); }
    ...
    void setUniform(const std::string & name, const std::vector<float> & vals);
    ...
    void setUniform(const std::string & name, const std::vector<glm::vec3> & vals);
